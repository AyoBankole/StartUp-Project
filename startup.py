...
st.markdown("<h1 style = 'color: #1F2544; text-align: center; font-family: Sans Serif '>STARTUP PREDICTOR</h1>", unsafe_allow_html = True)
...
st.image('pngwing.com.png', width = 100, use_column_width = True )
...
st.sidebar.image('startup.png', caption= 'Welcome User')
